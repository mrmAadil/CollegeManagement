...
namespace CollegeManagement.Location
{
    public partial class LocationMain : Form
    {
        ...
        private void icnBtnViewBuilding_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color1);
            openChildForm(new ViewBuilding());
        }

        private void icnBtnViewRoom_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color1);
            openChildForm(new ViewRoom());
        }
